...
if __name__ == '__main__':
    ...
    datestring = getdate()
    logging.info('========================= G_LIMMON check on {} ========================='.format(datestring))
    ...
    logging.info('Latest Archived G_LIMMON revision is {}.{}'.format(max_arch_revision[0], max_arch_revision[1]))

    arch_filename = "{}G_LIMMON_{}.{}.dec".format(archive, max_arch_revision[0], max_arch_revision[1])
    ...
    if new_hash != arch_hash:
        ...
        logging.info('Current G_LIMMON revision {}.{} added to archive'.format(new_revision[0], new_revision[1]))
        ...
        logging.info('Current G_LIMMON revision {}.{} already in archive'.format(new_revision[0], new_revision[1]))
